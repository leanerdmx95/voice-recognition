...
def main_program():
    ...
    gender_weights, gender_means, gender_stddev = get_data_files(models_path, "gender", 10) # 获取模型，mean, stddev存储路径
